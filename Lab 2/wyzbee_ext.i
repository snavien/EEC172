...
#line 39 ".\\WyzBee_ext\\WyzBee_ext.h"
...
#line 40 ".\\WyzBee_ext\\WyzBee_ext.h"
...
err_t WyzBee_Exint_IR_Init(WyzBee_exint_config_t* Config)
{
   ...
   do{ ((((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR06) = ((((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR06) & ~(((1u<<(2u))-1u)<<(4u)) | ((0x02u) << (4u)))); *((volatile unsigned int*)(0x42DE0080UL)) = 1u; *((volatile unsigned int*)(0x42DEA000UL)) = 0u; }while(0);;
   if(!(Exint_Init(&pstcConfig)))
	   return 0u;
   else return 2u;
