...
#line 18 "C:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\cstdio"


#line 26 "C:\\Keil_v5\\ARM\\ARMCC\\Bin\\..\\include\\cstdio"
...
int main()
{
		...
		{if(0u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(1u))); do{ *((volatile unsigned int*)(0x42DE8080UL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE4080UL))=1u; *((volatile unsigned int*)(0x42DE0080UL))=0u; *((volatile unsigned int*)(0x42DEA000UL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(1u))); do{ *((volatile unsigned int*)(0x42DE2080UL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE4080UL))=0u; *((volatile unsigned int*)(0x42DE0080UL))=0u; *((volatile unsigned int*)(0x42DEA000UL))=0u; }while(0); }while(0);};
		{if(1u){do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bInitVal=(1u))); do{ *((volatile unsigned int*)(0x42DE808CUL))=(__v__). bInitVal; *((volatile unsigned int*)(0x42DE408CUL))=1u; *((volatile unsigned int*)(0x42DE008CUL))=0u; *((volatile unsigned int*)(0x42DEA00CUL))=0u; }while(0); }while(0);} else do{ stc_gpio1pin_init_t __v__; __v__ . bPullup=0u;__v__ . bInitVal=0u; ((__v__ . bPullup=(1u))); do{ *((volatile unsigned int*)(0x42DE208CUL))=(__v__). bPullup; *((volatile unsigned int*)(0x42DE408CUL))=0u; *((volatile unsigned int*)(0x42DE008CUL))=0u; *((volatile unsigned int*)(0x42DEA00CUL))=0u; }while(0); }while(0);};
		while(1)
		{
