 ...
 ** 2013-06-18  0.3  MWi  PDL clock defintions for PDL initialization added
 ** 2013-07-05  0.4  MWi  PDL settings removed
 ** 2013-07-11  0.5  MWi  PLLN calculation corrected, PLLKMIN/MAX naming updated
 ** 2013-08-22  0.6  EZ   PLLKMIN/MAX value updated
 ** 2013-10-25  0.7  MWi  SWC_PSR_Val::TESTB note in user settings added
 ** 2014-01-15  0.8  EZ   Add the definition of Flash trace buffer function
 ** 2014-05-26  0.9  EZ   Add the Low-speed CR precaler value definition
 **                       Update error check definition for PSW_TMR_Val. 
 ******************************************************************************/
 ...
 ** - CLOCK_SETTING_CMSIS - Clock setting done in system_mbabxxx.h like in
 **                         FM4 template projects
 ******************************************************************************/ 
...
/**
 ******************************************************************************
 ** \brief Low-speed CR Prescaler Register value definition
 **        <i>(USER SETTING if CLOCK_SETTING_CMSIS or CLOCK_SETTING_PDL is set)</i>
 **
 ** Bit#5-0: : LCR_PRSLD
 ** - 0x00~0x3F
 ...
 **        <i>(DEVICE DEPENDENT SETTING)</i>
 ******************************************************************************/ 
#define __PLLCLKOUTMAX (320000000ul)
...
#if (CHECK_RSVD((APBC2_PSR_Val),  ~0x00000083ul))
...
#if (CHECK_RSVD((TTC_PSR_Val),    ~0x00000001ul))
