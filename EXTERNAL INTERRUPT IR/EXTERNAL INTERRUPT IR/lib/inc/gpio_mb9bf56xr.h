 ...
 **
 ** Headerfile for MB9BF56XR GPIO functions, included in gpio1pin.h
 **
 ** History:
...
#define GPIO1PIN_P1F_GET             ( bFM4_GPIO_PDIR1_P1F )

#define GPIO1PIN_P1F_PUT(v)          ( bFM4_GPIO_PDOR1_P1F=(v) )

#define GPIO1PIN_P1F_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P1F_INITIN(v) \
                                                        : GPIO1PIN_P1F_INITOUT(v) )

#define GPIO1PIN_P1F_INITIN(v)       do{ bFM4_GPIO_PCR1_P1F=(v).bPullup; \
                                         bFM4_GPIO_DDR1_P1F=0u; \
                                         bFM4_GPIO_PFR1_P1F=0u; }while(0)

#define GPIO1PIN_P1F_INITOUT(v)      do{ bFM4_GPIO_PDOR1_P1F=(v).bInitVal; \
                                         bFM4_GPIO_DDR1_P1F=1u; \
                                         bFM4_GPIO_PFR1_P1F=0u; }while(0)


/*---- GPIO bit NP1F ----*/
#define GPIO1PIN_NP1F_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR1_P1F)) )

#define GPIO1PIN_NP1F_PUT(v)         ( bFM4_GPIO_PDOR1_P1F=(uint32_t)(!(v)) )

#define GPIO1PIN_NP1F_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP1F_INITIN(v) \
                                                        : GPIO1PIN_NP1F_INITOUT(v) )

#define GPIO1PIN_NP1F_INITIN(v)      do{ bFM4_GPIO_PCR1_P1F=(v).bPullup; \
                                         bFM4_GPIO_DDR1_P1F=0u; \
                                         bFM4_GPIO_PFR1_P1F=0u; }while(0)

#define GPIO1PIN_NP1F_INITOUT(v)     do{ bFM4_GPIO_PDOR1_P1F=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR1_P1F=1u; \
                                         bFM4_GPIO_PFR1_P1F=0u; }while(0)
...
#define GPIO1PIN_P24_GET             ( bFM4_GPIO_PDIR2_P24 )

#define GPIO1PIN_P24_PUT(v)          ( bFM4_GPIO_PDOR2_P24=(v) )

#define GPIO1PIN_P24_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P24_INITIN(v) \
                                                        : GPIO1PIN_P24_INITOUT(v) )

#define GPIO1PIN_P24_INITIN(v)       do{ bFM4_GPIO_PCR2_P24=(v).bPullup; \
                                         bFM4_GPIO_DDR2_P24=0u; \
                                         bFM4_GPIO_PFR2_P24=0u; }while(0)

#define GPIO1PIN_P24_INITOUT(v)      do{ bFM4_GPIO_PDOR2_P24=(v).bInitVal; \
                                         bFM4_GPIO_DDR2_P24=1u; \
                                         bFM4_GPIO_PFR2_P24=0u; }while(0)


/*---- GPIO bit NP24 ----*/
#define GPIO1PIN_NP24_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR2_P24)) )

#define GPIO1PIN_NP24_PUT(v)         ( bFM4_GPIO_PDOR2_P24=(uint32_t)(!(v)) )

#define GPIO1PIN_NP24_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP24_INITIN(v) \
                                                        : GPIO1PIN_NP24_INITOUT(v) )

#define GPIO1PIN_NP24_INITIN(v)      do{ bFM4_GPIO_PCR2_P24=(v).bPullup; \
                                         bFM4_GPIO_DDR2_P24=0u; \
                                         bFM4_GPIO_PFR2_P24=0u; }while(0)

#define GPIO1PIN_NP24_INITOUT(v)     do{ bFM4_GPIO_PDOR2_P24=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR2_P24=1u; \
                                         bFM4_GPIO_PFR2_P24=0u; }while(0)
...
#define GPIO1PIN_P25_GET             ( bFM4_GPIO_PDIR2_P25 )

#define GPIO1PIN_P25_PUT(v)          ( bFM4_GPIO_PDOR2_P25=(v) )

#define GPIO1PIN_P25_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P25_INITIN(v) \
                                                        : GPIO1PIN_P25_INITOUT(v) )

#define GPIO1PIN_P25_INITIN(v)       do{ bFM4_GPIO_PCR2_P25=(v).bPullup; \
                                         bFM4_GPIO_DDR2_P25=0u; \
                                         bFM4_GPIO_PFR2_P25=0u; }while(0)

#define GPIO1PIN_P25_INITOUT(v)      do{ bFM4_GPIO_PDOR2_P25=(v).bInitVal; \
                                         bFM4_GPIO_DDR2_P25=1u; \
                                         bFM4_GPIO_PFR2_P25=0u; }while(0)


/*---- GPIO bit NP25 ----*/
#define GPIO1PIN_NP25_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR2_P25)) )

#define GPIO1PIN_NP25_PUT(v)         ( bFM4_GPIO_PDOR2_P25=(uint32_t)(!(v)) )

#define GPIO1PIN_NP25_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP25_INITIN(v) \
                                                        : GPIO1PIN_NP25_INITOUT(v) )

#define GPIO1PIN_NP25_INITIN(v)      do{ bFM4_GPIO_PCR2_P25=(v).bPullup; \
                                         bFM4_GPIO_DDR2_P25=0u; \
                                         bFM4_GPIO_PFR2_P25=0u; }while(0)

#define GPIO1PIN_NP25_INITOUT(v)     do{ bFM4_GPIO_PDOR2_P25=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR2_P25=1u; \
                                         bFM4_GPIO_PFR2_P25=0u; }while(0)
...
#define GPIO1PIN_P26_GET             ( bFM4_GPIO_PDIR2_P26 )

#define GPIO1PIN_P26_PUT(v)          ( bFM4_GPIO_PDOR2_P26=(v) )

#define GPIO1PIN_P26_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P26_INITIN(v) \
                                                        : GPIO1PIN_P26_INITOUT(v) )

#define GPIO1PIN_P26_INITIN(v)       do{ bFM4_GPIO_PCR2_P26=(v).bPullup; \
                                         bFM4_GPIO_DDR2_P26=0u; \
                                         bFM4_GPIO_PFR2_P26=0u; }while(0)

#define GPIO1PIN_P26_INITOUT(v)      do{ bFM4_GPIO_PDOR2_P26=(v).bInitVal; \
                                         bFM4_GPIO_DDR2_P26=1u; \
                                         bFM4_GPIO_PFR2_P26=0u; }while(0)


/*---- GPIO bit NP26 ----*/
#define GPIO1PIN_NP26_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR2_P26)) )

#define GPIO1PIN_NP26_PUT(v)         ( bFM4_GPIO_PDOR2_P26=(uint32_t)(!(v)) )

#define GPIO1PIN_NP26_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP26_INITIN(v) \
                                                        : GPIO1PIN_NP26_INITOUT(v) )

#define GPIO1PIN_NP26_INITIN(v)      do{ bFM4_GPIO_PCR2_P26=(v).bPullup; \
                                         bFM4_GPIO_DDR2_P26=0u; \
                                         bFM4_GPIO_PFR2_P26=0u; }while(0)

#define GPIO1PIN_NP26_INITOUT(v)     do{ bFM4_GPIO_PDOR2_P26=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR2_P26=1u; \
                                         bFM4_GPIO_PFR2_P26=0u; }while(0)
...
#define GPIO1PIN_P27_GET             ( bFM4_GPIO_PDIR2_P27 )

#define GPIO1PIN_P27_PUT(v)          ( bFM4_GPIO_PDOR2_P27=(v) )

#define GPIO1PIN_P27_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P27_INITIN(v) \
                                                        : GPIO1PIN_P27_INITOUT(v) )

#define GPIO1PIN_P27_INITIN(v)       do{ bFM4_GPIO_PCR2_P27=(v).bPullup; \
                                         bFM4_GPIO_DDR2_P27=0u; \
                                         bFM4_GPIO_PFR2_P27=0u; }while(0)

#define GPIO1PIN_P27_INITOUT(v)      do{ bFM4_GPIO_PDOR2_P27=(v).bInitVal; \
                                         bFM4_GPIO_DDR2_P27=1u; \
                                         bFM4_GPIO_PFR2_P27=0u; }while(0)


/*---- GPIO bit NP27 ----*/
#define GPIO1PIN_NP27_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR2_P27)) )

#define GPIO1PIN_NP27_PUT(v)         ( bFM4_GPIO_PDOR2_P27=(uint32_t)(!(v)) )

#define GPIO1PIN_NP27_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP27_INITIN(v) \
                                                        : GPIO1PIN_NP27_INITOUT(v) )

#define GPIO1PIN_NP27_INITIN(v)      do{ bFM4_GPIO_PCR2_P27=(v).bPullup; \
                                         bFM4_GPIO_DDR2_P27=0u; \
                                         bFM4_GPIO_PFR2_P27=0u; }while(0)

#define GPIO1PIN_NP27_INITOUT(v)     do{ bFM4_GPIO_PDOR2_P27=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR2_P27=1u; \
                                         bFM4_GPIO_PFR2_P27=0u; }while(0)
...
#define GPIO1PIN_P57_GET             ( bFM4_GPIO_PDIR5_P57 )

#define GPIO1PIN_P57_PUT(v)          ( bFM4_GPIO_PDOR5_P57=(v) )

#define GPIO1PIN_P57_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P57_INITIN(v) \
                                                        : GPIO1PIN_P57_INITOUT(v) )

#define GPIO1PIN_P57_INITIN(v)       do{ bFM4_GPIO_PCR5_P57=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P57=0u; \
                                         bFM4_GPIO_PFR5_P57=0u; }while(0)

#define GPIO1PIN_P57_INITOUT(v)      do{ bFM4_GPIO_PDOR5_P57=(v).bInitVal; \
                                         bFM4_GPIO_DDR5_P57=1u; \
                                         bFM4_GPIO_PFR5_P57=0u; }while(0)


/*---- GPIO bit NP57 ----*/
#define GPIO1PIN_NP57_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR5_P57)) )

#define GPIO1PIN_NP57_PUT(v)         ( bFM4_GPIO_PDOR5_P57=(uint32_t)(!(v)) )

#define GPIO1PIN_NP57_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP57_INITIN(v) \
                                                        : GPIO1PIN_NP57_INITOUT(v) )

#define GPIO1PIN_NP57_INITIN(v)      do{ bFM4_GPIO_PCR5_P57=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P57=0u; \
                                         bFM4_GPIO_PFR5_P57=0u; }while(0)

#define GPIO1PIN_NP57_INITOUT(v)     do{ bFM4_GPIO_PDOR5_P57=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR5_P57=1u; \
                                         bFM4_GPIO_PFR5_P57=0u; }while(0)
...
#define GPIO1PIN_P58_GET             ( bFM4_GPIO_PDIR5_P58 )

#define GPIO1PIN_P58_PUT(v)          ( bFM4_GPIO_PDOR5_P58=(v) )

#define GPIO1PIN_P58_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P58_INITIN(v) \
                                                        : GPIO1PIN_P58_INITOUT(v) )

#define GPIO1PIN_P58_INITIN(v)       do{ bFM4_GPIO_PCR5_P58=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P58=0u; \
                                         bFM4_GPIO_PFR5_P58=0u; }while(0)

#define GPIO1PIN_P58_INITOUT(v)      do{ bFM4_GPIO_PDOR5_P58=(v).bInitVal; \
                                         bFM4_GPIO_DDR5_P58=1u; \
                                         bFM4_GPIO_PFR5_P58=0u; }while(0)


/*---- GPIO bit NP58 ----*/
#define GPIO1PIN_NP58_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR5_P58)) )

#define GPIO1PIN_NP58_PUT(v)         ( bFM4_GPIO_PDOR5_P58=(uint32_t)(!(v)) )

#define GPIO1PIN_NP58_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP58_INITIN(v) \
                                                        : GPIO1PIN_NP58_INITOUT(v) )

#define GPIO1PIN_NP58_INITIN(v)      do{ bFM4_GPIO_PCR5_P58=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P58=0u; \
                                         bFM4_GPIO_PFR5_P58=0u; }while(0)

#define GPIO1PIN_NP58_INITOUT(v)     do{ bFM4_GPIO_PDOR5_P58=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR5_P58=1u; \
                                         bFM4_GPIO_PFR5_P58=0u; }while(0)
...
#define GPIO1PIN_P59_GET             ( bFM4_GPIO_PDIR5_P59 )

#define GPIO1PIN_P59_PUT(v)          ( bFM4_GPIO_PDOR5_P59=(v) )

#define GPIO1PIN_P59_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P59_INITIN(v) \
                                                        : GPIO1PIN_P59_INITOUT(v) )

#define GPIO1PIN_P59_INITIN(v)       do{ bFM4_GPIO_PCR5_P59=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P59=0u; \
                                         bFM4_GPIO_PFR5_P59=0u; }while(0)

#define GPIO1PIN_P59_INITOUT(v)      do{ bFM4_GPIO_PDOR5_P59=(v).bInitVal; \
                                         bFM4_GPIO_DDR5_P59=1u; \
                                         bFM4_GPIO_PFR5_P59=0u; }while(0)


/*---- GPIO bit NP59 ----*/
#define GPIO1PIN_NP59_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR5_P59)) )

#define GPIO1PIN_NP59_PUT(v)         ( bFM4_GPIO_PDOR5_P59=(uint32_t)(!(v)) )

#define GPIO1PIN_NP59_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP59_INITIN(v) \
                                                        : GPIO1PIN_NP59_INITOUT(v) )

#define GPIO1PIN_NP59_INITIN(v)      do{ bFM4_GPIO_PCR5_P59=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P59=0u; \
                                         bFM4_GPIO_PFR5_P59=0u; }while(0)

#define GPIO1PIN_NP59_INITOUT(v)     do{ bFM4_GPIO_PDOR5_P59=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR5_P59=1u; \
                                         bFM4_GPIO_PFR5_P59=0u; }while(0)
...
#define GPIO1PIN_P5A_GET             ( bFM4_GPIO_PDIR5_P5A )

#define GPIO1PIN_P5A_PUT(v)          ( bFM4_GPIO_PDOR5_P5A=(v) )

#define GPIO1PIN_P5A_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P5A_INITIN(v) \
                                                        : GPIO1PIN_P5A_INITOUT(v) )

#define GPIO1PIN_P5A_INITIN(v)       do{ bFM4_GPIO_PCR5_P5A=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P5A=0u; \
                                         bFM4_GPIO_PFR5_P5A=0u; }while(0)

#define GPIO1PIN_P5A_INITOUT(v)      do{ bFM4_GPIO_PDOR5_P5A=(v).bInitVal; \
                                         bFM4_GPIO_DDR5_P5A=1u; \
                                         bFM4_GPIO_PFR5_P5A=0u; }while(0)


/*---- GPIO bit NP5A ----*/
#define GPIO1PIN_NP5A_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR5_P5A)) )

#define GPIO1PIN_NP5A_PUT(v)         ( bFM4_GPIO_PDOR5_P5A=(uint32_t)(!(v)) )

#define GPIO1PIN_NP5A_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP5A_INITIN(v) \
                                                        : GPIO1PIN_NP5A_INITOUT(v) )

#define GPIO1PIN_NP5A_INITIN(v)      do{ bFM4_GPIO_PCR5_P5A=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P5A=0u; \
                                         bFM4_GPIO_PFR5_P5A=0u; }while(0)

#define GPIO1PIN_NP5A_INITOUT(v)     do{ bFM4_GPIO_PDOR5_P5A=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR5_P5A=1u; \
                                         bFM4_GPIO_PFR5_P5A=0u; }while(0)
...
#define GPIO1PIN_P5B_GET             ( bFM4_GPIO_PDIR5_P5B )

#define GPIO1PIN_P5B_PUT(v)          ( bFM4_GPIO_PDOR5_P5B=(v) )

#define GPIO1PIN_P5B_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P5B_INITIN(v) \
                                                        : GPIO1PIN_P5B_INITOUT(v) )

#define GPIO1PIN_P5B_INITIN(v)       do{ bFM4_GPIO_PCR5_P5B=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P5B=0u; \
                                         bFM4_GPIO_PFR5_P5B=0u; }while(0)

#define GPIO1PIN_P5B_INITOUT(v)      do{ bFM4_GPIO_PDOR5_P5B=(v).bInitVal; \
                                         bFM4_GPIO_DDR5_P5B=1u; \
                                         bFM4_GPIO_PFR5_P5B=0u; }while(0)


/*---- GPIO bit NP5B ----*/
#define GPIO1PIN_NP5B_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR5_P5B)) )

#define GPIO1PIN_NP5B_PUT(v)         ( bFM4_GPIO_PDOR5_P5B=(uint32_t)(!(v)) )

#define GPIO1PIN_NP5B_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP5B_INITIN(v) \
                                                        : GPIO1PIN_NP5B_INITOUT(v) )

#define GPIO1PIN_NP5B_INITIN(v)      do{ bFM4_GPIO_PCR5_P5B=(v).bPullup; \
                                         bFM4_GPIO_DDR5_P5B=0u; \
                                         bFM4_GPIO_PFR5_P5B=0u; }while(0)

#define GPIO1PIN_NP5B_INITOUT(v)     do{ bFM4_GPIO_PDOR5_P5B=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR5_P5B=1u; \
                                         bFM4_GPIO_PFR5_P5B=0u; }while(0)
...
#define GPIO1PIN_P64_GET             ( bFM4_GPIO_PDIR6_P64 )

#define GPIO1PIN_P64_PUT(v)          ( bFM4_GPIO_PDOR6_P64=(v) )

#define GPIO1PIN_P64_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P64_INITIN(v) \
                                                        : GPIO1PIN_P64_INITOUT(v) )

#define GPIO1PIN_P64_INITIN(v)       do{ bFM4_GPIO_PCR6_P64=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P64=0u; \
                                         bFM4_GPIO_PFR6_P64=0u; }while(0)

#define GPIO1PIN_P64_INITOUT(v)      do{ bFM4_GPIO_PDOR6_P64=(v).bInitVal; \
                                         bFM4_GPIO_DDR6_P64=1u; \
                                         bFM4_GPIO_PFR6_P64=0u; }while(0)


/*---- GPIO bit NP64 ----*/
#define GPIO1PIN_NP64_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR6_P64)) )

#define GPIO1PIN_NP64_PUT(v)         ( bFM4_GPIO_PDOR6_P64=(uint32_t)(!(v)) )

#define GPIO1PIN_NP64_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP64_INITIN(v) \
                                                        : GPIO1PIN_NP64_INITOUT(v) )

#define GPIO1PIN_NP64_INITIN(v)      do{ bFM4_GPIO_PCR6_P64=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P64=0u; \
                                         bFM4_GPIO_PFR6_P64=0u; }while(0)

#define GPIO1PIN_NP64_INITOUT(v)     do{ bFM4_GPIO_PDOR6_P64=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR6_P64=1u; \
                                         bFM4_GPIO_PFR6_P64=0u; }while(0)
...
#define GPIO1PIN_P65_GET             ( bFM4_GPIO_PDIR6_P65 )

#define GPIO1PIN_P65_PUT(v)          ( bFM4_GPIO_PDOR6_P65=(v) )

#define GPIO1PIN_P65_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P65_INITIN(v) \
                                                        : GPIO1PIN_P65_INITOUT(v) )

#define GPIO1PIN_P65_INITIN(v)       do{ bFM4_GPIO_PCR6_P65=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P65=0u; \
                                         bFM4_GPIO_PFR6_P65=0u; }while(0)

#define GPIO1PIN_P65_INITOUT(v)      do{ bFM4_GPIO_PDOR6_P65=(v).bInitVal; \
                                         bFM4_GPIO_DDR6_P65=1u; \
                                         bFM4_GPIO_PFR6_P65=0u; }while(0)


/*---- GPIO bit NP65 ----*/
#define GPIO1PIN_NP65_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR6_P65)) )

#define GPIO1PIN_NP65_PUT(v)         ( bFM4_GPIO_PDOR6_P65=(uint32_t)(!(v)) )

#define GPIO1PIN_NP65_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP65_INITIN(v) \
                                                        : GPIO1PIN_NP65_INITOUT(v) )

#define GPIO1PIN_NP65_INITIN(v)      do{ bFM4_GPIO_PCR6_P65=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P65=0u; \
                                         bFM4_GPIO_PFR6_P65=0u; }while(0)

#define GPIO1PIN_NP65_INITOUT(v)     do{ bFM4_GPIO_PDOR6_P65=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR6_P65=1u; \
                                         bFM4_GPIO_PFR6_P65=0u; }while(0)
...
#define GPIO1PIN_P66_GET             ( bFM4_GPIO_PDIR6_P66 )

#define GPIO1PIN_P66_PUT(v)          ( bFM4_GPIO_PDOR6_P66=(v) )

#define GPIO1PIN_P66_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P66_INITIN(v) \
                                                        : GPIO1PIN_P66_INITOUT(v) )

#define GPIO1PIN_P66_INITIN(v)       do{ bFM4_GPIO_PCR6_P66=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P66=0u; \
                                         bFM4_GPIO_PFR6_P66=0u; }while(0)

#define GPIO1PIN_P66_INITOUT(v)      do{ bFM4_GPIO_PDOR6_P66=(v).bInitVal; \
                                         bFM4_GPIO_DDR6_P66=1u; \
                                         bFM4_GPIO_PFR6_P66=0u; }while(0)


/*---- GPIO bit NP66 ----*/
#define GPIO1PIN_NP66_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR6_P66)) )

#define GPIO1PIN_NP66_PUT(v)         ( bFM4_GPIO_PDOR6_P66=(uint32_t)(!(v)) )

#define GPIO1PIN_NP66_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP66_INITIN(v) \
                                                        : GPIO1PIN_NP66_INITOUT(v) )

#define GPIO1PIN_NP66_INITIN(v)      do{ bFM4_GPIO_PCR6_P66=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P66=0u; \
                                         bFM4_GPIO_PFR6_P66=0u; }while(0)

#define GPIO1PIN_NP66_INITOUT(v)     do{ bFM4_GPIO_PDOR6_P66=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR6_P66=1u; \
                                         bFM4_GPIO_PFR6_P66=0u; }while(0)
...
#define GPIO1PIN_P67_GET             ( bFM4_GPIO_PDIR6_P67 )

#define GPIO1PIN_P67_PUT(v)          ( bFM4_GPIO_PDOR6_P67=(v) )

#define GPIO1PIN_P67_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P67_INITIN(v) \
                                                        : GPIO1PIN_P67_INITOUT(v) )

#define GPIO1PIN_P67_INITIN(v)       do{ bFM4_GPIO_PCR6_P67=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P67=0u; \
                                         bFM4_GPIO_PFR6_P67=0u; }while(0)

#define GPIO1PIN_P67_INITOUT(v)      do{ bFM4_GPIO_PDOR6_P67=(v).bInitVal; \
                                         bFM4_GPIO_DDR6_P67=1u; \
                                         bFM4_GPIO_PFR6_P67=0u; }while(0)


/*---- GPIO bit NP67 ----*/
#define GPIO1PIN_NP67_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR6_P67)) )

#define GPIO1PIN_NP67_PUT(v)         ( bFM4_GPIO_PDOR6_P67=(uint32_t)(!(v)) )

#define GPIO1PIN_NP67_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP67_INITIN(v) \
                                                        : GPIO1PIN_NP67_INITOUT(v) )

#define GPIO1PIN_NP67_INITIN(v)      do{ bFM4_GPIO_PCR6_P67=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P67=0u; \
                                         bFM4_GPIO_PFR6_P67=0u; }while(0)

#define GPIO1PIN_NP67_INITOUT(v)     do{ bFM4_GPIO_PDOR6_P67=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR6_P67=1u; \
                                         bFM4_GPIO_PFR6_P67=0u; }while(0)
...
#define GPIO1PIN_P68_GET             ( bFM4_GPIO_PDIR6_P68 )

#define GPIO1PIN_P68_PUT(v)          ( bFM4_GPIO_PDOR6_P68=(v) )

#define GPIO1PIN_P68_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P68_INITIN(v) \
                                                        : GPIO1PIN_P68_INITOUT(v) )

#define GPIO1PIN_P68_INITIN(v)       do{ bFM4_GPIO_PCR6_P68=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P68=0u; \
                                         bFM4_GPIO_PFR6_P68=0u; }while(0)

#define GPIO1PIN_P68_INITOUT(v)      do{ bFM4_GPIO_PDOR6_P68=(v).bInitVal; \
                                         bFM4_GPIO_DDR6_P68=1u; \
                                         bFM4_GPIO_PFR6_P68=0u; }while(0)


/*---- GPIO bit NP68 ----*/
#define GPIO1PIN_NP68_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR6_P68)) )

#define GPIO1PIN_NP68_PUT(v)         ( bFM4_GPIO_PDOR6_P68=(uint32_t)(!(v)) )

#define GPIO1PIN_NP68_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP68_INITIN(v) \
                                                        : GPIO1PIN_NP68_INITOUT(v) )

#define GPIO1PIN_NP68_INITIN(v)      do{ bFM4_GPIO_PCR6_P68=(v).bPullup; \
                                         bFM4_GPIO_DDR6_P68=0u; \
                                         bFM4_GPIO_PFR6_P68=0u; }while(0)

#define GPIO1PIN_NP68_INITOUT(v)     do{ bFM4_GPIO_PDOR6_P68=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR6_P68=1u; \
                                         bFM4_GPIO_PFR6_P68=0u; }while(0)
...
#define GPIO1PIN_P70_GET             ( bFM4_GPIO_PDIR7_P70 )

#define GPIO1PIN_P70_PUT(v)          ( bFM4_GPIO_PDOR7_P70=(v) )

#define GPIO1PIN_P70_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P70_INITIN(v) \
                                                        : GPIO1PIN_P70_INITOUT(v) )

#define GPIO1PIN_P70_INITIN(v)       do{ bFM4_GPIO_PCR7_P70=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P70=0u; \
                                         bFM4_GPIO_PFR7_P70=0u; }while(0)

#define GPIO1PIN_P70_INITOUT(v)      do{ bFM4_GPIO_PDOR7_P70=(v).bInitVal; \
                                         bFM4_GPIO_DDR7_P70=1u; \
                                         bFM4_GPIO_PFR7_P70=0u; }while(0)


/*---- GPIO bit NP70 ----*/
#define GPIO1PIN_NP70_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR7_P70)) )

#define GPIO1PIN_NP70_PUT(v)         ( bFM4_GPIO_PDOR7_P70=(uint32_t)(!(v)) )

#define GPIO1PIN_NP70_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP70_INITIN(v) \
                                                        : GPIO1PIN_NP70_INITOUT(v) )

#define GPIO1PIN_NP70_INITIN(v)      do{ bFM4_GPIO_PCR7_P70=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P70=0u; \
                                         bFM4_GPIO_PFR7_P70=0u; }while(0)

#define GPIO1PIN_NP70_INITOUT(v)     do{ bFM4_GPIO_PDOR7_P70=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR7_P70=1u; \
                                         bFM4_GPIO_PFR7_P70=0u; }while(0)
...
#define GPIO1PIN_P71_GET             ( bFM4_GPIO_PDIR7_P71 )

#define GPIO1PIN_P71_PUT(v)          ( bFM4_GPIO_PDOR7_P71=(v) )

#define GPIO1PIN_P71_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P71_INITIN(v) \
                                                        : GPIO1PIN_P71_INITOUT(v) )

#define GPIO1PIN_P71_INITIN(v)       do{ bFM4_GPIO_PCR7_P71=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P71=0u; \
                                         bFM4_GPIO_PFR7_P71=0u; }while(0)

#define GPIO1PIN_P71_INITOUT(v)      do{ bFM4_GPIO_PDOR7_P71=(v).bInitVal; \
                                         bFM4_GPIO_DDR7_P71=1u; \
                                         bFM4_GPIO_PFR7_P71=0u; }while(0)


/*---- GPIO bit NP71 ----*/
#define GPIO1PIN_NP71_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR7_P71)) )

#define GPIO1PIN_NP71_PUT(v)         ( bFM4_GPIO_PDOR7_P71=(uint32_t)(!(v)) )

#define GPIO1PIN_NP71_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP71_INITIN(v) \
                                                        : GPIO1PIN_NP71_INITOUT(v) )

#define GPIO1PIN_NP71_INITIN(v)      do{ bFM4_GPIO_PCR7_P71=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P71=0u; \
                                         bFM4_GPIO_PFR7_P71=0u; }while(0)

#define GPIO1PIN_NP71_INITOUT(v)     do{ bFM4_GPIO_PDOR7_P71=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR7_P71=1u; \
                                         bFM4_GPIO_PFR7_P71=0u; }while(0)
...
#define GPIO1PIN_P72_GET             ( bFM4_GPIO_PDIR7_P72 )

#define GPIO1PIN_P72_PUT(v)          ( bFM4_GPIO_PDOR7_P72=(v) )

#define GPIO1PIN_P72_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P72_INITIN(v) \
                                                        : GPIO1PIN_P72_INITOUT(v) )

#define GPIO1PIN_P72_INITIN(v)       do{ bFM4_GPIO_PCR7_P72=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P72=0u; \
                                         bFM4_GPIO_PFR7_P72=0u; }while(0)

#define GPIO1PIN_P72_INITOUT(v)      do{ bFM4_GPIO_PDOR7_P72=(v).bInitVal; \
                                         bFM4_GPIO_DDR7_P72=1u; \
                                         bFM4_GPIO_PFR7_P72=0u; }while(0)


/*---- GPIO bit NP72 ----*/
#define GPIO1PIN_NP72_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR7_P72)) )

#define GPIO1PIN_NP72_PUT(v)         ( bFM4_GPIO_PDOR7_P72=(uint32_t)(!(v)) )

#define GPIO1PIN_NP72_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP72_INITIN(v) \
                                                        : GPIO1PIN_NP72_INITOUT(v) )

#define GPIO1PIN_NP72_INITIN(v)      do{ bFM4_GPIO_PCR7_P72=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P72=0u; \
                                         bFM4_GPIO_PFR7_P72=0u; }while(0)

#define GPIO1PIN_NP72_INITOUT(v)     do{ bFM4_GPIO_PDOR7_P72=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR7_P72=1u; \
                                         bFM4_GPIO_PFR7_P72=0u; }while(0)
...
#define GPIO1PIN_P73_GET             ( bFM4_GPIO_PDIR7_P73 )

#define GPIO1PIN_P73_PUT(v)          ( bFM4_GPIO_PDOR7_P73=(v) )

#define GPIO1PIN_P73_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P73_INITIN(v) \
                                                        : GPIO1PIN_P73_INITOUT(v) )

#define GPIO1PIN_P73_INITIN(v)       do{ bFM4_GPIO_PCR7_P73=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P73=0u; \
                                         bFM4_GPIO_PFR7_P73=0u; }while(0)

#define GPIO1PIN_P73_INITOUT(v)      do{ bFM4_GPIO_PDOR7_P73=(v).bInitVal; \
                                         bFM4_GPIO_DDR7_P73=1u; \
                                         bFM4_GPIO_PFR7_P73=0u; }while(0)


/*---- GPIO bit NP73 ----*/
#define GPIO1PIN_NP73_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR7_P73)) )

#define GPIO1PIN_NP73_PUT(v)         ( bFM4_GPIO_PDOR7_P73=(uint32_t)(!(v)) )

#define GPIO1PIN_NP73_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP73_INITIN(v) \
                                                        : GPIO1PIN_NP73_INITOUT(v) )

#define GPIO1PIN_NP73_INITIN(v)      do{ bFM4_GPIO_PCR7_P73=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P73=0u; \
                                         bFM4_GPIO_PFR7_P73=0u; }while(0)

#define GPIO1PIN_NP73_INITOUT(v)     do{ bFM4_GPIO_PDOR7_P73=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR7_P73=1u; \
                                         bFM4_GPIO_PFR7_P73=0u; }while(0)
...
#define GPIO1PIN_P74_GET             ( bFM4_GPIO_PDIR7_P74 )

#define GPIO1PIN_P74_PUT(v)          ( bFM4_GPIO_PDOR7_P74=(v) )

#define GPIO1PIN_P74_INIT(v)         ( (0==(v).bOutput) ? GPIO1PIN_P74_INITIN(v) \
                                                        : GPIO1PIN_P74_INITOUT(v) )

#define GPIO1PIN_P74_INITIN(v)       do{ bFM4_GPIO_PCR7_P74=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P74=0u; \
                                         bFM4_GPIO_PFR7_P74=0u; }while(0)

#define GPIO1PIN_P74_INITOUT(v)      do{ bFM4_GPIO_PDOR7_P74=(v).bInitVal; \
                                         bFM4_GPIO_DDR7_P74=1u; \
                                         bFM4_GPIO_PFR7_P74=0u; }while(0)


/*---- GPIO bit NP74 ----*/
#define GPIO1PIN_NP74_GET            ( (uint32_t)(~(uint32_t)(bFM4_GPIO_PDIR7_P74)) )

#define GPIO1PIN_NP74_PUT(v)         ( bFM4_GPIO_PDOR7_P74=(uint32_t)(!(v)) )

#define GPIO1PIN_NP74_INIT(v)        ( (0==(v).bOutput) ? GPIO1PIN_NP74_INITIN(v) \
                                                        : GPIO1PIN_NP74_INITOUT(v) )

#define GPIO1PIN_NP74_INITIN(v)      do{ bFM4_GPIO_PCR7_P74=(v).bPullup; \
                                         bFM4_GPIO_DDR7_P74=0u; \
                                         bFM4_GPIO_PFR7_P74=0u; }while(0)

#define GPIO1PIN_NP74_INITOUT(v)     do{ bFM4_GPIO_PDOR7_P74=(uint32_t)(~((uint32_t)(v).bInitVal)); \
                                         bFM4_GPIO_DDR7_P74=1u; \
                                         bFM4_GPIO_PFR7_P74=0u; }while(0)
...
/*--- ADTG_8 for ADC#0 ---*/
#define SetPinFunc_ADTG_8_ADC0(dummy)        do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 12u, 4u, 0x09u ); \
                                                 bFM4_GPIO_PFR6_P66 = 1u; }while(0)

/*--- ADTG_8 for ADC#1 ---*/
#define SetPinFunc_ADTG_8_ADC1(dummy)        do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 16u, 4u, 0x09u ); \
                                                 bFM4_GPIO_PFR6_P66 = 1u; }while(0)

/*--- ADTG_8 for ADC#2 ---*/
#define SetPinFunc_ADTG_8_ADC2(dummy)        do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 20u, 4u, 0x09u ); \
                                                 bFM4_GPIO_PFR6_P66 = 1u; }while(0)
...
/*--- AIN1_0 ---*/
#define SetPinFunc_AIN1_0(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 6u, 2u, 0x01u ); \
                                                 bFM4_GPIO_PFR5_P58 = 1u; }while(0)
...
/*--- BIN1_0 ---*/
#define SetPinFunc_BIN1_0(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 8u, 2u, 0x01u ); \
                                                 bFM4_GPIO_PFR5_P59 = 1u; }while(0)
...
/*--- CTS4_2 ---*/
#define SetPinFunc_CTS4_2(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR08, 2u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR5_P5B = 1u; }while(0)
...
/*--- DTTI1X_1 ---*/
#define SetPinFunc_DTTI1X_1(dummy)           do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR02, 16u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR7_P74 = 1u; }while(0)
...
/*--- IC10_1 ---*/
#define SetPinFunc_IC10_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR02, 20u, 3u, 0x02u ); \
                                                 bFM4_GPIO_PFR7_P73 = 1u; }while(0)
...
/*--- IC11_1 ---*/
#define SetPinFunc_IC11_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR02, 23u, 3u, 0x02u ); \
                                                 bFM4_GPIO_PFR7_P72 = 1u; }while(0)
...
/*--- IC12_1 ---*/
#define SetPinFunc_IC12_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR02, 26u, 3u, 0x02u ); \
                                                 bFM4_GPIO_PFR7_P71 = 1u; }while(0)
...
/*--- IC13_1 ---*/
#define SetPinFunc_IC13_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR02, 29u, 3u, 0x02u ); \
                                                 bFM4_GPIO_PFR7_P70 = 1u; }while(0)
...
/*--- INT00_2 ---*/
#define SetPinFunc_INT00_2(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR06, 0u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR6_P68 = 1u; }while(0)
...
/*--- INT01_2 ---*/
#define SetPinFunc_INT01_2(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR06, 2u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR2_P24 = 1u; }while(0)
...
/*--- INT02_2 ---*/
#define SetPinFunc_INT02_2(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR06, 4u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR2_P27 = 1u; }while(0)
...
/*--- INT03_2 ---*/
#define SetPinFunc_INT03_2(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR06, 6u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR7_P73 = 1u; }while(0)
...
/*--- INT04_2 ---*/
#define SetPinFunc_INT04_2(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR06, 8u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR5_P58 = 1u; }while(0)
...
/*--- INT10_2 ---*/
#define SetPinFunc_INT10_2(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR06, 20u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR6_P64 = 1u; }while(0)
...
/*--- INT11_2 ---*/
#define SetPinFunc_INT11_2(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR06, 22u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR6_P66 = 1u; }while(0)
...
/*--- INT14_2 ---*/
#define SetPinFunc_INT14_2(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR06, 28u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR7_P72 = 1u; }while(0)
...
/*--- MNALE_0 ---*/
#define SetPinFunc_MNALE_0(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR10, 6u, 1u, 0x01u ); \
                                                 bFM4_GPIO_PFR3_P34 = 1u; }while(0)

/*--- MNCLE_0 ---*/
#define SetPinFunc_MNCLE_0(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR10, 6u, 1u, 0x01u ); \
                                                 bFM4_GPIO_PFR3_P35 = 1u; }while(0)

/*--- MNREX_0 ---*/
#define SetPinFunc_MNREX_0(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR10, 6u, 1u, 0x01u ); \
                                                 bFM4_GPIO_PFR3_P37 = 1u; }while(0)

/*--- MNWEX_0 ---*/
#define SetPinFunc_MNWEX_0(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR10, 6u, 1u, 0x01u ); \
                                                 bFM4_GPIO_PFR3_P36 = 1u; }while(0)
...
/*--- RTO01_1 ---*/
#define SetPinFunc_RTO01_1(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR01, 2u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR2_P24 = 1u; }while(0)
...
/*--- RTO02_1 ---*/
#define SetPinFunc_RTO02_1(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR01, 4u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR2_P25 = 1u; }while(0)
...
/*--- RTO03_1 ---*/
#define SetPinFunc_RTO03_1(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR01, 6u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR2_P26 = 1u; }while(0)
...
/*--- RTO04_1 ---*/
#define SetPinFunc_RTO04_1(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR01, 8u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR2_P27 = 1u; }while(0)
...
/*--- RTO05_1 ---*/
#define SetPinFunc_RTO05_1(dummy)            do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR01, 10u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR1_P1F = 1u; }while(0)
...
/*--- RX0_0 ---*/
#define SetPinFunc_RX0_0(dummy)              do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 24u, 2u, 0x01u ); \
                                                 bFM4_GPIO_PFR7_P71 = 1u; }while(0)
...
/*--- RX1_0 ---*/
#define SetPinFunc_RX1_0(dummy)              do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 28u, 2u, 0x01u ); \
                                                 bFM4_GPIO_PFR2_P24 = 1u; }while(0)

/*--- RX1_1 ---*/
#define SetPinFunc_RX1_1(dummy)              do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 28u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR5_P59 = 1u; }while(0)
...
/*--- SCK2_1 ---*/
#define SetPinFunc_SCK2_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR07, 20u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR2_P26 = 1u; }while(0)
...
/*--- SCK4_2 ---*/
#define SetPinFunc_SCK4_2(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR08, 8u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR5_P5A = 1u; }while(0)
...
/*--- SCK5_1 ---*/
#define SetPinFunc_SCK5_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR08, 14u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR6_P65 = 1u; }while(0)
...
/*--- SIN2_1 ---*/
#define SetPinFunc_SIN2_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR07, 16u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR2_P24 = 1u; }while(0)
...
/*--- SIN4_2 ---*/
#define SetPinFunc_SIN4_2(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR08, 4u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR5_P58 = 1u; }while(0)
...
/*--- SIN5_1 ---*/
#define SetPinFunc_SIN5_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR08, 10u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR6_P63 = 1u; }while(0)
...
/*--- SOT2_1 ---*/
#define SetPinFunc_SOT2_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR07, 18u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR2_P25 = 1u; }while(0)
...
/*--- SOT4_2 ---*/
#define SetPinFunc_SOT4_2(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR08, 6u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR5_P59 = 1u; }while(0)
...
/*--- SOT5_1 ---*/
#define SetPinFunc_SOT5_1(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR08, 12u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR6_P64 = 1u; }while(0)
...
/*--- TIOA4_2_OUT ---*/
#define SetPinFunc_TIOA4_2_OUT(dummy)        do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR05, 2u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR7_P70 = 1u; }while(0)
...
/*--- TIOA6_2_OUT ---*/
#define SetPinFunc_TIOA6_2_OUT(dummy)        do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR05, 18u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR2_P27 = 1u; }while(0)
...
/*--- TIOA7_2_IN ---*/
#define SetPinFunc_TIOA7_2_IN(dummy)         do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR05, 24u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR6_P67 = 1u; }while(0)

/*--- TIOA7_2_OUT ---*/
#define SetPinFunc_TIOA7_2_OUT(dummy)        do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR05, 26u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR6_P67 = 1u; }while(0)
...
/*--- TIOB4_2_IN ---*/
#define SetPinFunc_TIOB4_2_IN(dummy)         do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR05, 4u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR7_P71 = 1u; }while(0)
...
/*--- TIOB6_2_IN ---*/
#define SetPinFunc_TIOB6_2_IN(dummy)         do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR05, 20u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR1_P1F = 1u; }while(0)
...
/*--- TIOB7_2_IN ---*/
#define SetPinFunc_TIOB7_2_IN(dummy)         do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR05, 28u, 2u, 0x03u ); \
                                                 bFM4_GPIO_PFR6_P68 = 1u; }while(0)
...
/*--- TX0_0 ---*/
#define SetPinFunc_TX0_0(dummy)              do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 26u, 2u, 0x01u ); \
                                                 bFM4_GPIO_PFR7_P70 = 1u; }while(0)
...
/*--- TX1_0 ---*/
#define SetPinFunc_TX1_0(dummy)              do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 30u, 2u, 0x01u ); \
                                                 bFM4_GPIO_PFR2_P25 = 1u; }while(0)

/*--- TX1_1 ---*/
#define SetPinFunc_TX1_1(dummy)              do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 30u, 2u, 0x02u ); \
                                                 bFM4_GPIO_PFR5_P5A = 1u; }while(0)
...
/*--- ZIN1_0 ---*/
#define SetPinFunc_ZIN1_0(dummy)             do{ PINRELOC_SET_EPFR( FM4_GPIO->EPFR09, 10u, 2u, 0x01u ); \
                                                 bFM4_GPIO_PFR5_P5A = 1u; }while(0)
