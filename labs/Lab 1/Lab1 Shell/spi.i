...
#line 27 "CalBee_oled\\spi.h"
#line 1 ".\\lib\\inc\\calbee.h"
...
#line 70 "C:\\Keil\\ARM\\ARMCC\\bin\\..\\include\\stddef.h"
...
#line 91 "C:\\Keil\\ARM\\ARMCC\\bin\\..\\include\\stddef.h"
...
#line 126 ".\\lib\\inc\\exint.h"
  
#line 159 ".\\lib\\inc\\exint.h"

#line 192 ".\\lib\\inc\\exint.h"
...
#line 1 ".\\lib\\inc\\gpio_mb9bf56xr.h"
...
#line 55 ".\\lib\\inc\\gpio_mb9bf56xr.h"
...
#line 140 ".\\lib\\inc\\gpio.h"
#line 146 ".\\lib\\inc\\gpio.h"
...
#line 27 "CalBee_oled\\spi.c"
#line 28 "CalBee_oled\\spi.c"
...
static void wifi_cs_enable(void)
{
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR0_f.P0E = 0u;				
}
...
static void wifi_cs_disable(void)
{
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR0_f.P0E = 1u;				
}
...
void wifi_reset_routine (void)
{
#line 118 "CalBee_oled\\spi.c"

#line 144 "CalBee_oled\\spi.c"
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR1_f.P1E = 0u;	
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->DDR1_f.P1E = 1u;	
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR1_f.P1E = 0u;	
	delay(100); 									
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR1_f.P1E = 1u;	
	return;
...
void calbee_spi_init(void)
{
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR0_f.P0E = 0u;				
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->DDR0_f.P0E = 1u;				
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR0_f.P0E = 1u;				


	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR0 = ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR0 | 0X3800;					
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 = ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 | 0X002A0000; 
	...
	(void)Mfs_Csio_DeInit(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL)))); 										
	if (Ok != Mfs_Csio_Init(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))), (stc_mfs_csio_config_t *)&stcMfsCsioCfg)) 	
	{
		(void)Mfs_Csio_DeInit(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))));
		((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR0 = ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR0 | 0x3800;					
		((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 = ((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->EPFR08 | 0X002A0000; 
	}
	Mfs_Csio_SetSckOutEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))), 1u);	

	Mfs_SetTxEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))), 1u);	

	Mfs_SetRxEnable(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))), 1u);	
...
int16 rsi_spi_send(uint8 *ptrBuf, uint16 bufLen, uint8 *valBuf, uint8 mode)
{
	...
	for (i = 0, j = 0; i < bufLen; j++)
	{
...

		{
			...
			do
			{
				u8Reg = Mfs_GetStatus(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))), (0x02u));
			} while ((u8Reg & (0x02u)) != (0x02u));

			u16Data_tx = (uint16)ptrBuf[i];
			Mfs_WriteData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))), u16Data_tx);
			i += 1;

			do
			{
				u8Reg = Mfs_GetStatus(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))), (0x04u));
			} while ((u8Reg & (0x04u)) != (0x04u));

			u16Data_rx = Mfs_ReadData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))));
		}
#line 299 "CalBee_oled\\spi.c"
		if ((j < 2))
		{
...
int16 rsi_spi_recv(uint8 *ptrBuf, uint16 bufLen, uint8 mode)
{
	...
	for (i = 0; i < bufLen; )
	{
...

		{
			...
			Mfs_WriteData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))), u16Data_dumy);
			do
			{
				u8Reg = Mfs_GetStatus(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))), (0x04u));
			} while ((u8Reg & (0x04u)) != (0x04u));

			u16Data = Mfs_ReadData(&(*((volatile stc_mfsn_t *) ((0x40000000UL) + 0x38600UL))));
			ptrBuf[i] = (uint8)u16Data;
			i++;
		}
#line 380 "CalBee_oled\\spi.c"
...
void power_on(void)
{
	...
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PFR6_f.P66 = 0u;	
	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->DDR6_f.P66 = 1u;	

	((FM4_GPIO_TypeDef *)((0x40000000UL) + 0x6F000UL))->PDOR6_f.P66 = 1u;	
	delay(2000);
}
